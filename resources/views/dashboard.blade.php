                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    @if(auth()->user()->role->name == 'manager')
                        ...
                        <div class="mt-6">
                                ...
                                <div class="rounded-xl border p-5 shadow-md w-9/12 bg-white">
                                    <div class="flex w-full items-center justify-between border-b pb-3">
                                        ...
                                        <div class="flex items-center space-x-8">
                                            ...
                                            <div class="text-xs text-neutral-500 pr-4">2022-12-14 12:40</div>
                                        </div>
                                    </div>
                            ...
                            <div class='flex items-center justify-center min-w-screen mt-6'>
                                <div class="rounded-xl border p-7 shadow-md w-9/12 bg-white">
                                    <div class="flex w-full items-center justify-between border-b pb-3">
                                        <div class="flex items-center space-x-3">
                                            <div
                                                class="h-10 w-9 rounded-full bg-slate-400 bg-[url('https://i.pravatar.cc/32')]">
